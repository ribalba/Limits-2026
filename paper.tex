...
%-----------------------------------------------------------------------------------------
\section{Case Study: Measurement Setup and Data Collection}
%-----------------------------------------------------------------------------------------
...
\begin{itemize}
  ...
  \item \texttt{Grid-Intensity}: grid intensity used for conversion, in \(\mathrm{gCO_2e/kWh}\).
